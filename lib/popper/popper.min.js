...
function isShadowRoot(e) {
  return (
    ...
    (e instanceof getWindow(e).ShadowRoot || e instanceof ShadowRoot)
  )
}
...
function getBoundingClientRect(e, t, n) {
  ...
  t &&
    isHTMLElement(e) &&
    ((r = (0 < e.offsetWidth && round(o.width) / e.offsetWidth) || 1),
    (i = (0 < e.offsetHeight && round(o.height) / e.offsetHeight) || 1))
  ;(t = (isElement(e) ? getWindow(e) : window).visualViewport),
    (e = !isLayoutViewport() && n),
    (n = (o.left + (e && t ? t.offsetLeft : 0)) / r),
    (e = (o.top + (e && t ? t.offsetTop : 0)) / i),
    (t = o.width / r),
    (r = o.height / i)
  return {
    width: t,
...
function getDocumentElement(e) {
  return ((isElement(e) ? e.ownerDocument : e.document) || window.document)
    .documentElement
}
...
function isElementScaled(e) {
  var t = e.getBoundingClientRect(),
    ...
    t = round(t.height) / e.offsetHeight || 1
  return 1 !== n || 1 !== t
}
function getCompositeRect(e, t, n) {
  void 0 === n && (n = !1)
  var o = isHTMLElement(t),
    r = isHTMLElement(t) && isElementScaled(t),
    i = getDocumentElement(t),
    e = getBoundingClientRect(e, r, n),
    r = { scrollLeft: 0, scrollTop: 0 },
    a = { x: 0, y: 0 }
  return (
    (!o && n) ||
      (("body" === getNodeName(t) && !isScrollParent(i)) ||
        (r = getNodeScroll(t)),
      isHTMLElement(t)
        ? (((a = getBoundingClientRect(t, !0)).x += t.clientLeft),
          (a.y += t.clientTop))
        : i && (a.x = getWindowScrollBarX(i))),
    {
      x: e.left + r.scrollLeft - a.x,
      y: e.top + r.scrollTop - a.y,
      width: e.width,
      height: e.height,
    }
  )
...
function listScrollParents(e, t) {
  ...
  var n = getScrollParent(e),
    ...
    o = getWindow(n),
    o = e ? [o].concat(o.visualViewport || [], isScrollParent(n) ? n : []) : n,
    n = t.concat(o)
  return e ? n : n.concat(listScrollParents(getParentNode(o)))
}
...
function getContainingBlock(e) {
  ...
  if (n && isHTMLElement(e) && "fixed" === getComputedStyle(e).position)
    return null
  var o = getParentNode(e)
  for (
    isShadowRoot(o) && (o = o.host);
    isHTMLElement(o) && ["html", "body"].indexOf(getNodeName(o)) < 0;
...
function getOffsetParent(e) {
  for (
    ...
    n && isTableElement(n) && "static" === getComputedStyle(n).position;
...
function validateModifiers(o) {
  o.forEach(function (n) {
    ;[]
      .concat(Object.keys(n), VALID_PROPERTIES)
      ...
      .forEach(function (e) {
        switch (e) {
          ...
          case "enabled":
            ...
            break
          case "phase":
            modifierPhases.indexOf(n.phase) < 0 &&
              console.error(
                format(
                  INVALID_MODIFIER_ERROR,
                  n.name,
        ...
        n.requires &&
          n.requires.forEach(function (t) {
            null ==
              o.find(function (e) {
                return e.name === t
              }) &&
              console.error(
                format(MISSING_DEPENDENCY_ERROR, String(n.name), t, t)
              )
          })
      })
  })
...
function getViewportRect(e, t) {
  ...
  return (
    o &&
      ((i = o.width),
      (r = o.height),
      ((n = isLayoutViewport()) || (!n && "fixed" === t)) &&
        ((a = o.offsetLeft), (s = o.offsetTop))),
    { width: i, height: r, x: a + getWindowScrollBarX(e), y: s }
  )
}
function getDocumentRect(e) {
  var t = getDocumentElement(e),
    n = getWindowScroll(e),
    o = null == (o = e.ownerDocument) ? void 0 : o.body,
    r = max(
      t.scrollWidth,
      t.clientWidth,
      o ? o.scrollWidth : 0,
    ...
    e = -n.scrollLeft + getWindowScrollBarX(e),
    n = -n.scrollTop
  return (
    "rtl" === getComputedStyle(o || t).direction &&
      (e += max(t.clientWidth, o ? o.clientWidth : 0) - r),
    { width: r, height: i, x: e, y: n }
  )
}
...
function getInnerBoundingClientRect(e, t) {
  t = getBoundingClientRect(e, !1, "fixed" === t)
  return (
...
function getClippingRect(n, e, t, o) {
  ;(e = "clippingParents" === e ? getClippingParents(n) : [].concat(e)),
    (e = [].concat(e, [t])),
    (t = e[0]),
    (e = e.reduce(function (e, t) {
      t = getClientRectFromMixedType(n, t, o)
      return (
        (e.top = max(t.top, e.top)),
        (e.right = min(t.right, e.right)),
        (e.bottom = min(t.bottom, e.bottom)),
        (e.left = max(t.left, e.left)),
        e
      )
    }, getClientRectFromMixedType(n, t, o)))
  return (
...
function computeOffsets(e) {
  var t,
    ...
    o = e.element,
    e = e.placement,
    r = e ? getBasePlacement(e) : null,
    e = e ? getVariation(e) : null,
    i = n.x + n.width / 2 - o.width / 2,
    a = n.y + n.height / 2 - o.height / 2
  switch (r) {
    case top:
      t = { x: i, y: n.y - o.height }
      break
    case bottom:
  ...
  var s = r ? getMainAxisFromPlacement(r) : null
  if (null != s) {
...
function detectOverflow(e, t) {
  var o,
    ...
    i = t.boundary,
    i = void 0 === i ? clippingParents : i,
    a = t.rootBoundary,
    a = void 0 === a ? viewport : a,
    s = t.elementContext,
    s = void 0 === s ? popper : s,
    l = t.altBoundary,
    l = void 0 !== l && l,
    t = t.padding,
    t = void 0 === t ? 0 : t,
    t = mergePaddingObject(
      "number" != typeof t ? t : expandToHashMap(t, basePlacements)
    ),
    p = e.rects.popper,
    l = e.elements[l ? (s === popper ? reference : popper) : s],
    l = getClippingRect(
      isElement(l)
        ? l
        : l.contextElement || getDocumentElement(e.elements.popper),
      i,
      a,
      r
    ),
    ...
    r = rectToClientRect(Object.assign({}, p, a)),
    p = s === popper ? r : i,
    f = {
      top: l.top - p.top + t.top,
      bottom: p.bottom - l.bottom + t.bottom,
      left: l.left - p.left + t.left,
      right: p.right - l.right + t.right,
    },
    ...
    var s = {
      ...
      p = {
        ...
        setOptions: function (e) {
          var e = "function" == typeof e ? e(s.options) : e,
            e =
              (i(),
              (s.options = Object.assign({}, f, s.options, e)),
              (s.scrollParents = {
                reference: isElement(t)
                  ? listScrollParents(t)
                  : t.contextElement
                  ? listScrollParents(t.contextElement)
                  : [],
                popper: listScrollParents(n),
              }),
              orderModifiers(mergeByName([].concat(a, s.options.modifiers))))
          return (
            ...
            "production" !== process.env.NODE_ENV &&
              (validateModifiers(
                uniqueBy([].concat(e, s.options.modifiers), function (e) {
                  return e.name
                })
              ),
              getBasePlacement(s.options.placement) !== auto ||
                s.orderedModifiers.find(function (e) {
                  return "flip" === e.name
                }) ||
                console.error(
                  [
              ...
              [
                (e = getComputedStyle(n)).marginTop,
                e.marginRight,
                e.marginBottom,
                e.marginLeft,
              ].some(function (e) {
        ...
        forceUpdate: function () {
          if (!l) {
            ...
            if (areValidElements(t, e)) {
              ...
              for (
                var n, o, r, i = 0, a = 0;
                a < s.orderedModifiers.length;
                a++
              ) {
                if ("production" !== process.env.NODE_ENV && 100 < (i += 1)) {
                  console.error(INFINITE_LOOP_ERROR)
                  break
                }
                !0 === s.reset
                  ? ((s.reset = !1), (a = -1))
                  : ((n = (r = s.orderedModifiers[a]).fn),
                    (o = r.options),
                    (r = r.name),
                    "function" == typeof n &&
                      (s =
...
function effect$2(e) {
  ...
  return (
    ...
    i && a.addEventListener("resize", n.update, passive),
    function () {
      r &&
        s.forEach(function (e) {
          e.removeEventListener("scroll", n.update, passive)
        }),
        i && a.removeEventListener("resize", n.update, passive)
    }
  )
}
var eventListeners = {
...
function roundOffsetsByDPR(e, t) {
  ...
  return { x: round(n * t) / t || 0, y: round(e * t) / t || 0 }
}
function mapToStyles(e) {
  var t,
    ...
    u = s.y,
    u = void 0 === u ? 0 : u,
    m = "function" == typeof c ? c({ x: d, y: u }) : { x: d, y: u },
    m = ((d = m.x), (u = m.y), s.hasOwnProperty("x")),
    ...
    y =
      (f &&
        ((y = "clientHeight"),
        (n = "clientWidth"),
        (t = getOffsetParent(o)) === getWindow(o) &&
          "static" !== getComputedStyle((t = getDocumentElement(o))).position &&
          "absolute" === l &&
          ((y = "scrollHeight"), (n = "scrollWidth")),
        (i !== top && ((i !== left && i !== right) || a !== end)) ||
          ((h = bottom),
          (u =
            (u -
              ((e && t === v && v.visualViewport
                ? v.visualViewport.height
                : t[y]) -
                r.height)) *
            (p ? 1 : -1))),
        (i !== left && ((i !== top && i !== bottom) || a !== end)) ||
          ((g = right),
          (d =
            (d -
              ((e && t === v && v.visualViewport
                ...
                r.width)) *
            (p ? 1 : -1)))),
      Object.assign({ position: l }, f && unsetSides)),
    i =
      !0 === c
        ? roundOffsetsByDPR({ x: d, y: u }, getWindow(o))
        : { x: d, y: u }
  return (
    (d = i.x),
    (u = i.y),
...
function computeStyles(e) {
  var t,
    ...
    o =
      ("production" !== process.env.NODE_ENV &&
        ((t = getComputedStyle(n.elements.popper).transitionProperty || ""),
        r &&
...
function distanceAndSkiddingToXY(e, t, n) {
  var o = getBasePlacement(e),
    ...
    t = "function" == typeof n ? n(Object.assign({}, t, { placement: e })) : n,
    e = t[0] || 0,
    n = (t[1] || 0) * r
  return 0 <= [left, right].indexOf(o) ? { x: n, y: e } : { x: e, y: n }
}
function offset(e) {
  var n = e.state,
    t = e.options,
    ...
    t = t.offset,
    o = void 0 === t ? [0, 0] : t,
    t = placements.reduce(function (e, t) {
      return (e[t] = distanceAndSkiddingToXY(t, n.rects, o)), e
    }, {}),
    r = t[n.placement],
    i = r.x,
    r = r.y
  null != n.modifiersData.popperOffsets &&
    ((n.modifiersData.popperOffsets.x += i),
    (n.modifiersData.popperOffsets.y += r)),
    (n.modifiersData[e] = t)
}
var offset$1 = {
    name: "offset",
...
function flip(e) {
  var n = e.state,
    t = e.options,
    e = e.name
  if (!n.modifiersData[e]._skip) {
    for (
      var o = t.mainAxis,
        r = void 0 === o || o,
        o = t.altAxis,
        i = void 0 === o || o,
        o = t.fallbackPlacements,
        a = t.padding,
        s = t.boundary,
        l = t.rootBoundary,
        p = t.altBoundary,
        ...
        t = getBasePlacement(f),
        o =
          o ||
          (t === f || !c
            ? [getOppositePlacement(f)]
            : getExpandedFallbackPlacements(f)),
        u = [f].concat(o).reduce(function (e, t) {
          return e.concat(
            getBasePlacement(t) === auto
              ? computeAutoPlacement(n, {
                  placement: t,
                  boundary: s,
                  rootBoundary: l,
                  padding: a,
      ...
      var w = u[b],
        O = getBasePlacement(w),
        x = getVariation(w) === start,
        E = 0 <= [top, bottom].indexOf(O),
        P = E ? "width" : "height",
        S = detectOverflow(n, {
          placement: w,
          boundary: s,
        ...
        E = E ? (x ? right : left) : x ? bottom : top,
        x =
          (m[P] > g[P] && (E = getOppositePlacement(E)),
          getOppositePlacement(E)),
        P = []
      if (
        (r && P.push(S[O] <= 0),
        i && P.push(S[E] <= 0, S[x] <= 0),
        P.every(function (e) {
          return e
        }))
      ) {
    ...
    if (v)
      for (var R = c ? 3 : 1; 0 < R; R--)
        if (
          ...
          break
    n.placement !== y &&
      ((n.modifiersData[e]._skip = !0), (n.placement = y), (n.reset = !0))
  }
}
var flip$1 = {
  name: "flip",
...
function preventOverflow(e) {
  var t,
    ...
    g = getBasePlacement(f.placement),
    v = getVariation(f.placement),
    h = !v,
    b = getMainAxisFromPlacement(g),
    w = getAltAxis(b),
    O = f.modifiersData.popperOffsets,
    x = f.rects.reference,
    E = f.rects.popper,
    c =
      "function" == typeof c
        ? c(Object.assign({}, f.rects, { placement: f.placement }))
        : c,
    c =
      "number" == typeof c
        ? { mainAxis: c, altAxis: c }
        : Object.assign({ mainAxis: 0, altAxis: 0 }, c),
    P = f.modifiersData.offset ? f.modifiersData.offset[f.placement] : null,
    S = { x: 0, y: 0 }
  O &&
    (d &&
      ((d = "y" === b ? "height" : "width"),
      (l = (t = O[b]) + m[(r = "y" === b ? top : left)]),
      (p = t - m[(n = "y" === b ? bottom : right)]),
      (o = y ? -E[d] / 2 : 0),
      (a = (v === start ? x : E)[d]),
      (v = v === start ? -E[d] : -x[d]),
      (s = f.elements.arrow),
      (s = y && s ? getLayoutRect(s) : { width: 0, height: 0 }),
      (r = (i = f.modifiersData["arrow#persistent"]
        ? f.modifiersData["arrow#persistent"].padding
        : getFreshSideObject())[r]),
      (i = i[n]),
      (n = within(0, x[d], s[d])),
      (s = h ? x[d] / 2 - o - n - r - c.mainAxis : a - n - r - c.mainAxis),
      (a = h ? -x[d] / 2 + o + n + i + c.mainAxis : v + n + i + c.mainAxis),
      (h = (r = f.elements.arrow && getOffsetParent(f.elements.arrow))
        ? "y" === b
          ? r.clientTop || 0
          : r.clientLeft || 0
        : 0),
      (v = t + a - (o = null != (d = null == P ? void 0 : P[b]) ? d : 0)),
      (n = within(y ? min(l, t + s - o - h) : l, t, y ? max(p, v) : p)),
      (O[b] = n),
      (S[b] = n - t)),
    u &&
      ((i = "y" === w ? "height" : "width"),
      (a = (r = O[w]) + m["x" === b ? top : left]),
      (d = r - m["x" === b ? bottom : right]),
      (s = -1 !== [top, left].indexOf(g)),
      (h = null != (o = null == P ? void 0 : P[w]) ? o : 0),
      (l = s ? a : r - x[i] - E[i] - h + c.altAxis),
      (v = s ? r + x[i] + E[i] - h - c.altAxis : d),
      (p = y && s ? withinMaxClamp(l, r, v) : within(y ? l : a, r, y ? v : d)),
      (O[w] = p),
      (S[w] = p - r)),
    (f.modifiersData[e] = S))
}
      ...
      "number" !=
        typeof (e =
          "function" == typeof e
            ...
            : e)
        ? e
        : expandToHashMap(e, basePlacements)
    )
  }
function arrow(e) {
  var t,
    ...
    p = getBasePlacement(i.placement),
    f = getMainAxisFromPlacement(p),
    p = 0 <= [left, right].indexOf(p) ? "height" : "width"
  s &&
    l &&
    ((e = toPaddingObject(e.padding, i)),
    (t = getLayoutRect(s)),
    (r = "y" === f ? top : left),
    (o = "y" === f ? bottom : right),
    (n =
      i.rects.reference[p] + i.rects.reference[f] - l[f] - i.rects.popper[p]),
    (l = l[f] - i.rects.reference[f]),
    ...
    (r = e[r]),
    (e = s - t[p] - e[o]),
    (r = within(r, (o = s / 2 - t[p] / 2 + (n / 2 - l / 2)), e)),
    (i.modifiersData[a] = (((s = {})[f] = r), (s.centerOffset = r - o), s)))
}
function effect(e) {
  var t = e.state,
    e = e.options.element,
...
function hide(e) {
  var t = e.state,
    ...
    i = detectOverflow(t, { elementContext: "reference" }),
    a = detectOverflow(t, { altBoundary: !0 }),
    i = getSideOffsets(i, n),
    n = getSideOffsets(a, o, r),
    a = isAnySideFullyClipped(i),
    o = isAnySideFullyClipped(n)
  ;(t.modifiersData[e] = {
